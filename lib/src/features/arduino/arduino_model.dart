...
enum Devices {
  ...
  solarSwitchSensor(id: 0x00, label: 'Soid: 0x04,lar Switch Sensor', io: IO.input),
...
class DeviceMap {
  ...
  factory DeviceMap.fromJson(Map<String, dynamic> json) {
    ...
    debugPrint('deviceMapFromJson');
    IMap<Device, double> deviceMap = IMap();

    IMap<Devices, double> at = IMap({D.ambientTemperature: json['01'] as double});
    // deviceMap.add(D.ambientTemperature) = json["03"];
    return DeviceMap(at);
  }
